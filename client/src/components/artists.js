    ...
    render() {
        ...
        <Container id="artists" ref={this.props.ref1}>
            ...
            <br></br> We found {this.props.numArtistsOverlap} of your top artists on Blonded with { this.props.recommendedTracksByArtistUris.length }
             {this.props.recommendedTracksByArtistUris.length == 1 ? <p style={{display: 'inline'}}> song </p> : <p style={{display: 'inline'}}> songs </p> } featured that you don't have saved. 
             {this.props.recommendedTracksByArtistUris.length == 0 ? <p style={{display: 'inline'}}> You know your favorite artists pretty well. </p> : <p style={{display: 'inline'}}></p> }
            </p>
