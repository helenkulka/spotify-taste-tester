...
const DiscoBall = () => {
    ...
    useEffect(() => {
      ...
      return (
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="globe" id="globe" viewBox="0 0 210 210">
  <defs>
...
<svg xmlns="http://www.w3.org/2000/svg" className="globe" id="sturs" viewBox="0 0 210 210">
				<path className="stur" id="stur-1" d="M48.036 42.036L44.5 48.5l-3.536-6.464L34.5 38.5l6.464-3.536L44.5 28.5l3.536 6.464L54.5 38.5l-6.464 3.536z"/>
		    <path className="stur" id="stur-2" d="M168.083 59.441l-3.536 6.464-3.535-6.464-6.465-3.536 6.465-3.535 3.535-6.465 3.536 6.465 6.464 3.535-6.464 3.536z"/>
    		<path className="stur" id="stur-3" d="M135.083 99.894l-3.536 6.464-3.535-6.464-6.465-3.536 6.465-3.536 3.535-6.464 3.536 6.464 6.464 3.536-6.464 3.536z"/>
</svg>
        </div>
    </div>
      )
